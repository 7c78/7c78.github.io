...
======================
After modifying the static contents Jekyll will need to rebuild the website.
This can be done with `jekyll build` or by testing the changes out with the
integrated webserver `jekyll serve`.
...
* Questions on [Jekyll’s dedicated Help repository](https://github.com/jekyll/jekyll-help).
